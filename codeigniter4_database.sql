...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Sep 2020 pada 14.40
...
-- Database: `dbcafein`
--
CREATE DATABASE IF NOT EXISTS `dbcafein` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbcafein`;
...
('root', '[{\"db\":\"dbcafein\",\"table\":\"tblkategori\"}]');
...
('root', '2020-09-13 12:26:37', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
